...
const BlueYellowHeader = ({}) => {
  return (
    <div className="bg-[#F1C933] w-full md:h-[140px] ">
      {" "}
      {/* Removed items-center */}
      <div className="bg-[#0B42AF] justify-center w-full flex flex-row">
        {" "}
        {/* Added 1px top margin */}
        <div className="flex md:space-x-80 space-x-5">
          <Image
            src="/BHLOGO.avif"
            width={1920}
            height={750}
            className="md:h-[90px] h-[60px] md:w-full w-[170px] object-cover"
            alt="Logo"
          />
          ...
          <div className="flex mt-5">
            ...
            <div className="flex flex-col ml-2">
              <p className="md:w-[140px] font-bold">Call for Bookings</p>
              <p className="md:w-[120px] font-bold ml-5">0208 004 3311</p>
            </div>
          </div>
        </div>
      </div>
      <div className="flex md:flex-row flex-col justify-center md:space-x-5   ">
        ...
        <p className="text-blue-700 hover:bg-[#EEEEEE] p-2 mt-1">
          REQUEST A CALLBACK
        </p>
